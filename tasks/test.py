...
for j in arr:
    new_arr = j.split(' ')
    if 'through' in new_arr:
        new_arr.remove('through')
    if 'turn' in new_arr:
        new_arr.remove('turn')
    num = new_arr[1].split(',')
    num2 = new_arr[2].split(',')
    x = []
    y =[]
    for i in num:
        y.append(int(i))
...
# arr = []
# counter = 0
# with open('/home/olya/Рабочий стол/python/03.txt','r') as f:
#     for i in f:
#         arr.append(i)
# arr = [line.rstrip() for line in arr]
# for i in arr:
...
# arr = []
# with open('/home/olya/Рабочий стол/python/04.txt','r') as f:
#     for i in f:
#         arr.append(i)
# arr = [line.rstrip() for line in arr]
# print(arr)
...
#
# print(ar)
# #ar = [['nyot', 'babgr', 'babgr', 'kqtu', 'kqtu', 'kzshonp', 'ylyk', 'psqk'], ['iix', 'ewj', 'rojvbkk', 'phrij', 'iix', 'zuajnk', 'tadv', 'givslju', 'ewj', 'bda'], ['nyot', 'babgr', 'kqtu', 'kzshonp', 'ylyk', 'psqk']]
# counter = 0
# count = 0
# arrr = []
# for i in ar:
...
#             # c = 0
#             # while c < len(i):
#             #     if sorted(m) == sorted(i[c]):
#             #         if i.index(m) != i.index(i[c]):
#             #             counter += 1
#             #             break
#             #     c += 1
# print(len(ar)-count)
...
#             # print('second:' + m[c])
#             # print('comparing: '+k)
#             # if sorted(k) == sorted(m[c]):
#             #     if i.index(k) != i.index(m[c]):
#             #         counter += 1
#             #         break
#             print(counter)
#             c += 1
#
# print(len(arrr)-counter)
